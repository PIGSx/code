...
const cards = [
  ...
  },
  {
    id: 2,
    title: "aplicativo",
    description: "Baixas de materiais (base)",
    link: "/materiaisapp",
  },
];
...
function Polos() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 via-gray-950 to-black py-16 px-4 text-gray-100">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-10 max-w-6xl mx-auto justify-center justify-items-center">
        {cards.map((card) => (
          <div
            key={card.id}
            onClick={() => navigate(card.link)}
            className="group relative bg-gradient-to-br from-gray-800 to-gray-900 rounded-3xl shadow-lg hover:shadow-blue-500/30 transition-all duration-300 cursor-pointer overflow-hidden border border-gray-700 hover:border-blue-400 w-72"
          >
